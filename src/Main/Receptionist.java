...
public class Receptionist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mLabel.setFont(new java.awt.Font("Arial", 2, 24)); // NOI18N
        mLabel.setForeground(new java.awt.Color(0, 255, 204));
        mLabel.setText("Hospital Management System");

        dUser.setBackground(new java.awt.Color(0, 0, 51));
        dUser.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        dUser.setForeground(new java.awt.Color(0, 0, 51));
        ...
        plbl.setForeground(new java.awt.Color(0, 0, 51));
        ...
        rExitBtn.setBackground(new java.awt.Color(0, 0, 0));
        ...
        rLoginBtn.setBackground(new java.awt.Color(0, 0, 0));
